...
The company wanted to have all their data in one place. They chose to migrate CRM data into their existing ERP system. That meant ~800 records across Accounts, Contacts, and Opportunities needed to move over cleanly, with all the reporting and dashboards the sales team relied on rebuilt from scratch on the new platform.
